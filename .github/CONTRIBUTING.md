Contributions include code, documentation (and spelling mistakes!), answering user questions, running the project's infrastructure, and advocating for all types of users.
